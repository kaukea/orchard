...
- `feature · todo · · queued · · gh#25` [Orchard: the fleet workbench — global view, selection, dispatch](TODO.md.d/orchard.md) ~github-board-sync ~cross-repo-inbox
  ...
  - `feature · todo · · queued · process ·` [Bloom administering: batched question blocks, blind axes, no duplicate probes](TODO.md.d/bloom-administering.md) ~psychometric-discovery
...
- `refactor · todo · · queued · process ·` [Bus message specifying: tighten the vocabulary, fix what each agent sends](TODO.md.d/bus-message-specifying.md) ~message-bus ~fleet-documenting ~sidebar-witnessing
