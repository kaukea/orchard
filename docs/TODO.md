...
- `feature · todo · · blocked-on-answers · process ·` [Summon restart: summon and window naming redesigned from scratch — old spec never approved](TODO.md.d/summon-restarting.md) ~orchestrator-identity ~session-naming ~sidebar-titling
