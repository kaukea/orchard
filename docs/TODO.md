...
- `bug · todo · critical · working · sync · gh#299` [DEFCON-1 delivery restoring: consumers re-attached to latest main via the conventional manifest path, integration-tested in CI](TODO.md.d/delivery-restoring.md) ~manifest-adapting ~sync-suggest-reset ~chkdsk
