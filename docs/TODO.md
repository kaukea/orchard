...
- `feature · todo · critical · blocked-on-answers · process ·` [Decisions restructured: split the register by kind, and fix how agents apply what they find](TODO.md.d/decisions-restructuring.md) ~decisions-reviewing ~injection-integrity ~deviance-detection ~decision-projecting
