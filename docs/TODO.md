...
- `feature · todo · · queued · process ·` [Sidebar round: aesthetics, teamwork functionality, and a refactor of the renderer](TODO.md.d/sidebar-teamwork.md) ⊘transport-test-reconciling ~sidebar-polish ~sidebar-empty-rows ~fleet-sidebar
